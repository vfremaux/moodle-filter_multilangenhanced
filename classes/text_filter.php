...
namespace filter_multilangenhanced;
...
class text_filter extends \core_filters\text_filter {
    ...
    public function filter($text, array $options = array()) {
        ...
        if (empty($CFG->filter_multilang_force_old) and !empty($CFG->filter_multilang_converted)) {
            ...
            $outbuffer = preg_replace_callback($search1, ['filter_multilangenhanced\text_filter', 'multilangenhanced_filter_lang_impl'], $text);
        }
     ...
     *
     */
    public static function multilangenhanced_filter_lang_impl($langblock) {
        global $CFG;
